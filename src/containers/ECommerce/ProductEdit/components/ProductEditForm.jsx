...
function ProductEditForm ({ handleSubmit, reset,productinfo}) {
          ...
          <div className="form__form-group">
            ...
            <div className="form__form-group-field">
              <Field
                ...
                component="input"
                type="text"
                onChange={(event,value)=>{Product.name = value; setProduct(Product);}}
              />
            </div>
          </div>
            ...
            <div className="form__form-group form__form-group-id">
              ...
              <div className="form__form-group-field">
                <Field
                  ...
                  component="input"
                  type="text"
                  onChange={(event,value)=>{Product.id = value; setProduct(Product);}}
                />
              </div>
            </div>
            <div className="form__form-group">
