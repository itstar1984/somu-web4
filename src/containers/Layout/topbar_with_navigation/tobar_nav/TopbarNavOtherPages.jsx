    ...
    <DropdownMenu className="topbar__nav-dropdown-menu dropdown__menu">
      ...
      <DropdownItem>
        <TopbarNavCategory title="E-commerce" icon="cart">
          <TopbarNavLink title="Cart" route="/dashboard/cart" />
          <TopbarNavLink title="Catalog" route="/dashboard/catalog" />
          <TopbarNavLink title="Orders List" route="/dashboard/orders_list" />
          <TopbarNavLink title="Payment" route="/dashboard/payment" />
          <TopbarNavLink title="Product Edit" route="/dashboard/product_edit" />
          <TopbarNavLink title="Product Page" route="/dashboard/product_page" />
          <TopbarNavLink title="Products List" route="/dashboard/products_list" />
        </TopbarNavCategory>
      </DropdownItem>
      <DropdownItem>
