    ...
    return (
      <div className="sidebar__content">
        <ul className="sidebar__block">
          <SidebarLink title="Ackoo Dashboard" icon="home" route="/dashboard_default" onClick={this.hideSidebar} />
          <SidebarLink
            hidden={true}
          ...
          />
          <SidebarCategory hidden={true} title="Layout" icon="layers">
        ...
        <ul className="sidebar__block">
          <SidebarCategory hidden={true} title="UI Elements" icon="diamond">
          ...
          <SidebarLink hidden={true}  title="Mail Application" icon="envelope" route="/mail" onClick={this.hideSidebar} />
          <SidebarLink hidden={true}  title="Chat Application" icon="bubble" route="/chat" onClick={this.hideSidebar} />
          <SidebarLink hidden={true}  title="Todo Application" icon="book" newLink route="/todo" onClick={this.hideSidebar} />
          <SidebarCategory hidden={false} title="Forms" icon="file-add">
          ...
          <SidebarCategory hidden={false} title="Tables" icon="list" isNew>
          ...
          <SidebarCategory hidden={true} title="Charts" icon="chart-bars">
          ...
          <SidebarCategory hidden={true} title="Maps" icon="map">
        ...
        <ul className="sidebar__block">
          <SidebarCategory hidden={true} title="Account" icon="user">
          ...
          <SidebarCategory title="Campaigns Menu" icon="list">
            <SidebarLink title="New Campaign" route="/dashboard/campaigns/new" onClick={this.hideSidebar} />
            <SidebarLink title="Campaigns" route="/dashboard/campaigns" onClick={this.hideSidebar} />
          </SidebarCategory>
          <SidebarCategory title="Quick Menu" icon="cart">
            <SidebarLink title="Cart" route="/dashboard/cart" onClick={this.hideSidebar} />
            <SidebarLink title="Catalog" route="/dashboard/catalog" onClick={this.hideSidebar} />
            <SidebarLink title="Payment" route="/dashboard/payment" onClick={this.hideSidebar} />
            <SidebarLink title="Product Edit" route="/dashboard/product_edit" onClick={this.hideSidebar} />
            <SidebarLink title="Product Page" route="/dashboard/product_page" onClick={this.hideSidebar} />
            <SidebarLink title="Products List" route="/dashboard/products_list" onClick={this.hideSidebar} />
            <SidebarLink title="Categories List" route="/dashboard/categories_list" onClick={this.hideSidebar} />
            <SidebarLink title="Brands List" route="/dashboard/brands_list" onClick={this.hideSidebar} />
            <SidebarLink title="Brands Edit" route="/dashboard/brands_edit" onClick={this.hideSidebar} />
          </SidebarCategory>
          <SidebarCategory hidden={true} title="Default Pages" icon="file-empty">
          ...
          <SidebarCategory hidden={true} title="Multilevel Menu " icon="menu">
            <SidebarLink title="Second Level Item" />
            <SidebarCategory hidden={true} title="Second Level Item">
