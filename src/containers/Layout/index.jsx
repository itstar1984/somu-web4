...
const showNotification = (rtl) => {
  notification.notice({
    content: <BasicNotification
      title="👋 Welcome to the ACKOO Admin!"
      message="You have successfully logged in to the ACKOO Admin. Now you can start to explore the dashboard
                interface with a bunch of advanced features. Enjoy!"
    />,
    duration: 5,
    closable: true,
